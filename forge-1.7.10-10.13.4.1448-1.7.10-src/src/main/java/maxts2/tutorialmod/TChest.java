/*
 * Left off at www.youtube.com/watch?v=gdYcgtOa_7g  at 18:37
 * 
 */
...
public class TChest extends BlockChest {
	
	private final Random field_149955_b = new Random();

	public TChest(int p_i45397_1_) {
		super(p_i45397_1_);
	 ...
	 public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
	    {
	        ...
	        {
	            ((TileEntityTChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
	        }
	    }
	 ...
	 public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	    {
	        ...
	        TileEntityTChest TileEntityTChest = (TileEntityTChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);

	        if (TileEntityTChest != null)
	        {
	            TileEntityTChest.updateContainingBlockInfo();
	        }
	    }

	    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
	    {
	        TileEntityTChest TileEntityTChest = (TileEntityTChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

	        if (TileEntityTChest != null)
	        {
	            for (int i1 = 0; i1 < TileEntityTChest.getSizeInventory(); ++i1)
	            {
	                ItemStack itemstack = TileEntityTChest.getStackInSlot(i1);
	    ...
	    {
	        Object object = (TileEntityTChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
	        ...
	        else
	        {
	            ...
	            {
	                object = new InventoryLargeChest("Large T Chest", (TileEntityTChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
	            }

	            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
	            {
	                object = new InventoryLargeChest("Large T Chest", (IInventory)object, (TileEntityTChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
	            }

	            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
	            {
	                object = new InventoryLargeChest("Large T Chest", (TileEntityTChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
	            }

	            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
	            {
	                object = new InventoryLargeChest("Large T Chest", (IInventory)object, (TileEntityTChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
	            }
	    ...
	    {
	        TileEntityTChest TileEntityTChest = new TileEntityTChest();
	        return TileEntityTChest;
	    }
	    ...
	    {
	        this.blockIcon = p_149651_1_.registerIcon(ATutorialMod.MODID + ":TChest");
	    }
